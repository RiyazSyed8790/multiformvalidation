  ...
  return (
    <main className="App bg-[#EEF5FF] ubu w-screen h-screen flex justify-center md:items-center">
      <section className=' bg-[#EEF5FF] md:bg-white rounded-xl flex justify-center items-end md:items-start flex-wrap md:flex-nowrap md:w-2/3 w-full h-full md:h-2/3'>
        ...
        <section className='rounded-xl px-2 py-2 md:px-0 md:py-0 flex justify-center text-left info w-3/4 h-4/5 md:h-full z-10 bg-white'>
          ...
          <div>
              <label className=' text-[#48546D]  text-base'>Name</label><br/>
              <input className=' text-[#012257] font-semibold  outline-blue-800 grayBord w-full rounded-md px-2 py-2' type='text' placeholder='e.g. Stephen King' required />
            </div>
            <div>
              <label className=' text-[#48546D]  text-base'>Email Address</label><br/>
              <input className=' text-[#012257] font-semibold outline-blue-800 grayBord w-full rounded-md px-2 py-2' type='email' placeholder='e.g. Stephenking@lorem.com' required />
            </div>
            <div>
              <label className=' text-[#48546D]  text-base'>Phone Number</label><br/>
              <input className=' text-[#012257] font-semibold outline-blue-800 grayBord w-full rounded-md px-2 py-2' type='tel' placeholder='e.g. +1 234 567 890' required />
            </div>
