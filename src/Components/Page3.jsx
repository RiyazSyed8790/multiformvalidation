          ...
          <div className='flex  flex-col justify-between w-4/5 h-full md:justify-evenly '>
            ...
            <div className="checks child:my-2 ">
                <div className="first-cond grayBord  flex items-center px-1 py-3 md:py-4 md:px-4  justify-between ">
                    ...
                    <input className=" accent-[#443EF9] w-5 h-5 rounded-md " type="checkbox" value="Online service"  />
                    ...
                    <h3 className=' text-gray-500 text-sm'>$10/yr</h3>
                </div>
                <div className="first-cond grayBord   flex items-center px-1 py-3 md:py-4 md:px-4  justify-between ">
                    <div className="flex  items-center child:mx-1 md:child:mx-2 ">
                    <input className=" accent-[#443EF9] w-5 h-5 rounded-md " type="checkbox" value="Larger storage"  />
                    <div className=" md:mx-4">
                    ...
                    <h3 className=' text-gray-500 text-sm'>$20/yr</h3>
                </div>
                <div className="first-cond grayBord  flex items-center px-1 py-3 md:py-4 md:px-4  justify-between ">
                    <div className="flex  items-center child:mx-1 md:child:mx-2 ">
                    <input className=" accent-[#443EF9] w-5 h-5 rounded-md " type="checkbox" value="Customaizable profile"  />
                    <div className=" md:mx-4">
