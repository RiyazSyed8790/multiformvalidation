...
export default function Page2(props){
  const [hidden,setHidden] = React.useState(1);  
    ...
    return(
        <section className=' rounded-xl  px-0 py-4 md:px-0 md:py-0 flex justify-center text-left info w-4/5 h-4/5 md:h-full z-10 bg-white'>
            ...
            <div className="tiers-section flex flex-wrap md:flex-nowrap w-full child:my-2 md:child:mr-2 justify-between">
              <div onClick={()=>props.tier(1)} style={props.active===1?{borderColor:"blue"}:{}} className="tier-card md:w-1/3 w-full cursor-pointer md:h-full grayBord flex md:flex-col px-4 py-4 justify-start items-center md:items-start  md:justify-between">
                ...
                <div className=" mx-4 md:my-2 md:mx-0">
                  ...
                  <h3 style={hidden===1?{display:"none"}:{display:"block"}} className=' text-gray-500 text-sm'>$9/month</h3>
                  <h3 style={hidden===2?{display:"none"}:{display:"block"}} className=' text-gray-500 text-sm'>$90/yr</h3>
                  <h3 style={hidden===2?{display:"none"}:{display:"block"}} className=' text-[#012257] text-sm font-thin'>2 months free</h3>
                </div>
              </div>
              ...
              <div className=" mx-4 md:my-2 md:mx-0">
                  ...
                  <h3 style={hidden===1?{display:"none"}:{display:"block"}} className=' text-gray-500 text-sm'>$12/month</h3>
                  <h3 style={hidden===2?{display:"none"}:{display:"block"}} className=' text-gray-500 text-sm'>$120/yr</h3>
                  <h3 style={hidden===2?{display:"none"}:{display:"block"}} className=' text-[#012257] text-sm font-thin'>2 months free</h3>
                </div>
              </div>
              ...
              <div className=" mx-4 md:my-2 md:mx-0">
                  ...
                  <h3 style={hidden===1?{display:"none"}:{display:"block"}} className=' text-gray-500 text-sm'>$15/month</h3>
                  <h3 style={hidden===2?{display:"none"}:{display:"block"}} className=' text-gray-500 text-sm'>$150/yr</h3>
                  <h3 style={hidden===2?{display:"none"}:{display:"block"}} className=' text-[#012257] text-sm font-thin'>2 months free</h3>
                </div>
              </div>
            </div>
            <div className=" flex  items-center  md:h-1/6 justify-center child:mx-4 ">
              ...
              <div className=" flex justify-between items-center child:mx-1 rounded-xl bg-[#012257] md:w-[10%] md:h-1/3 w-[1/5] h-4/5  ">
                <button onClick={()=>toggler(2)} style={hidden===1?{backgroundColor:"#012257"}:{}} className="  bg-white rounded-xl h-3 w-3 md:h-4 md:w-4"></button>
                <button onClick={()=>toggler(1)} style={hidden===2?{backgroundColor:"#012257"}:{}} className="  bg-white  rounded-xl h-3 w-3 md:h-4 md:w-4"></button>
              </div>
