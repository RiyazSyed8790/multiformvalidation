        ...
        <section className='rounded-xl px-4 py-4 md:px-0 md:py-0 flex justify-center text-left info w-4/5 h-4/5 md:h-full z-10 bg-white'>
          <div className='flex flex-col justify-between h-full md:justify-evenly '>
            ...
            <div>
              ...
              <input id="name" name='name' value={props.name_val}  onChange={(e)=>props.change(e)} className=' text-[#012257] focus:font-semibold  outline-blue-800 grayBord w-full rounded-md px-2 py-2' type='text' placeholder='e.g. Stephen King' required />
            </div>
            <div>
              <div className=' flex w-full justify-between'>
              ...
              <input id="mail" name="email" value={props.email_val} onChange={(e)=>props.change(e)}  className=' text-[#012257] focus:font-semibold outline-blue-800 grayBord w-full rounded-md px-2 py-2' type='email' placeholder='e.g. Stephenking@lorem.com' required />
            </div>
            <div>
              <div className=' flex w-full justify-between'>
              ...
              <input id="number" name="phone" value={props.phone_val} onChange={(e)=>props.change(e)}  className=' text-[#012257] focus:font-semibold outline-blue-800 grayBord w-full rounded-md px-2 py-2' type='tel' placeholder='e.g. +1 234 567 890' required />
            </div>
